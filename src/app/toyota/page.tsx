    ...
    <div className="my-4 md:my-8 mx-4 md:mx-8 lg:mx-32 p-4 flex flex-col items-center">
      ...
      <div className="flex justify-center w-full my-4 md:my-6">
        <Image 
          ...
          width={400}
          height={400}
          className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg" // Make image responsive
        />
      </div>
      ...
      <div className="flex flex-col justify-center items-center pb-10">
        <p className="text-[22px] sm:text-[24px] md:text-[26px] py-5 text-green-500">PKR 50,00,000</p>
